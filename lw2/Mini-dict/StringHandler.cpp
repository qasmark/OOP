...
//						TESTS
//std::string test1 = "     help   me      pleaASEFSe ";
//std::string test2 = "        TOLOWERCASE        WiTH exTrA SpAcES   Ye   S    ";
//
//std::cout << "|" << ToLowerCaseWithTrim(test2) << "|" << "\n";
//std::cout << "|" << ToLowerCaseWithTrim(test1) << "|" << "\n";