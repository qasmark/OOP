...
ShapesHandler::ShapesHandler(std::istream& input, std::ostream& output)
	...
	, m_actionMap({ { "line", bind(&ShapesHandler::CreateLine, this, std::placeholders::_1) },
		  { "circle", bind(&ShapesHandler::CreateCircle, this, std::placeholders::_1) },
		  { "rectangle", bind(&ShapesHandler::CreateRectangle, this, std::placeholders::_1) },
		  { "triangle", bind(&ShapesHandler::CreateTriangle, this, std::placeholders::_1) },
		  { "help", bind(&ShapesHandler::Help, this, std::placeholders::_1) },
		  { "printAllShapes", bind(&ShapesHandler::PrintAllShapes, this, std::placeholders::_1) } })
{
} // перенести в объ€вление класса

bool ShapesHandler::HandleCommand() const
{
...
bool ShapesHandler::CreateLine(std::istream& args)
{
	if (args.eof())
	{
...
bool ShapesHandler::CreateCircle(std::istream& args)
{
	if (args.eof())
	{
		m_outputStream << "Correct usage:" << std::endl
...
bool ShapesHandler::CreateRectangle(std::istream& args)
{
	if (args.eof())
	{
		m_outputStream << "Correct usage:" << std::endl
...
bool ShapesHandler::CreateTriangle(std::istream& args)
{
	if (args.eof())
	{
		m_outputStream << "Correct usage:" << std::endl
...
void ShapesHandler::PrintMaxAreaShape() const
{
...
void ShapesHandler::PrintMinPerimeterShape() const
{
...
void ShapesHandler::DrawShaped(unsigned width, unsigned height, const std::string& windowTitle) const
{
...
bool ShapesHandler::PrintAllShapes(std::istream& args)
{
...
bool ShapesHandler::Help(std::istream& args)
{
